...
![500](/images/l2chem-sio2-lewis.png)

Count how many bonds $Si$, and $O$ can have. If the number of bonds in the lewis diagram doesn't match the number of possible bonds (that you calculated), then it's pretty likely a covalent network, since that means that the structure can infinitely expand like this to achieve its full octet:\
![500](/images/l2chem-sio2-lattice.png)
...
![500](/images/l2chem-sicl4-lewis.png)\
Now, compare the bond count in the lewis structure to the possible bond counts (calculated from the formula). $Cl$ can have 1 possible bond, and $Si$ can have 4 possible bonds. This matches the lewis diagram, which means that the lewis diagram can't expand like the $SiO_{2}$ example. This means that the molecule stops here. Since it doesn't expand, it is a molecular solid!
