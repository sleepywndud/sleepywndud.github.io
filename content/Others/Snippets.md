...
```js
// This is the actual snippet for the Obsidian plugin 'Latex Suite'.
// Paste this code block into your snippets file, and should work!

// Key trigger set to [TAB]

export default [

// TRIGGER MATH MODE
{trigger: "mk", replacement: "$$0$", options: "tA"}, // inline latex
{trigger: "dm", replacement: "$$$0$$", options: "tAw"}, // block latex
{trigger: "vm", replacement: "$$\n$0\n$$", options: "tAw"}, // block latex, but for NBTS
...
{trigger: "xx", replacement: "\\cdot", options: "mA"},
...
// CUSTOM TRIGGERS
{trigger: "fox", replacement: "f(x)", options: "mA"},{trigger: "inv", replacement: "^{-1}$0", options: "mA"},
...
{trigger: "3deriv", replacement: "\\frac{d^3y}{dx^3}", options: "mA"},
{trigger: "2prmtr", replacement: "\\frac{d\\left( \\frac{dy}{dx} \\right)}{dt}\\cdot \\frac{dt}{dx}", options: "mA"},
...
{trigger: "2sim", replacement: "\\left\\{\\begin{aligned}$0 \\\\$1\\end{aligned}\\right.", options: "mA"},
{trigger: "3sim", replacement: "\\left\\{\\begin{aligned}$0 \\\\$1 \\\\$2 \\end{aligned}\\right.", options: "mA"},
{trigger: "cnj", replacement: "\\overline{$0}", options: "mA"},
{trigger: "cis", replacement: "\\text{cis}$0", options: "mA"},
{trigger: "arg", replacement: "\\text{arg}$0", options: "mA"},
{trigger: "tq", replacement: "\\tau$0", options: "mA"},
{trigger: "ox", replacement: "(x)", options: "mA"},
{trigger: "pox", replacement: "'(x)", options: "mA" },
{trigger: "qed", replacement: " \\ {∎} $0", options: "mA"},
{trigger: "3synthdiv", replacement: "\\begin{array}{r|rrrr}\n   & 0 & 0 & 0 & 0 \\\\\n0  & ↓ & 0  & 0 & 0  \\\\\n\\hline\n  & 0 & 0 & 0  & \\boxed{0}\n\\end{array}", options: "mA" },
